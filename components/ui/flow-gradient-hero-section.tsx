...
export default function FlowGradientHero() {
    ...
    return (
        <div className="relative w-full h-full min-h-screen overflow-hidden bg-[#030303]">
            <div ref={containerRef} className="absolute inset-0 z-0" />

            {/* Content Overlay */}
            <div className="relative z-10 flex flex-col items-center justify-center w-full min-h-screen text-center px-4 pt-48 pb-20">
                <motion.div
